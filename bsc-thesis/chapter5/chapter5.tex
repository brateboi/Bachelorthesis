...
\end{figure}
The next degenerate case where the ray lies exactly on a face or goes exactly through an edge are all handled similarly.
...
The final algorithm $\op{tetFinder}$ is presented in pseudocode here. The algorithm is described using operations such as:
\begin{itemize}
